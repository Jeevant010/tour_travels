    ...
    ? [
        {
          ...
          value:
            flightDetails.Departure_From?.split("(")[0]?.trim() ||
            "Not specified",
        ...
        },
        {
          ...
          value:
            flightDetails.Going_to?.split("(")[0]?.trim() || "Not specified",
        ...
        },
        {
          ...
          value: flightDetails.Return_Date
            ? formatDate(flightDetails.Return_Date)
            : "One-way trip",
        },
        {
        ...
        },
        {
          ...
          value: flightDetails.Class
            ? `${flightDetails.Class.charAt(
                0
              ).toUpperCase()}${flightDetails.Class.slice(1)}`
            : "Not specified",
        },
      ]
    : null;
    ...
    <div className="flight-page-container">
      ...
      <div className="train-pnr-button-container">
        ...
        <button
          className="train-pnr-button"
          onClick={() =>
            navigate("/Optflight", { state: { flightData: flightDetails } })
          }
        >
          Check the Most Optimized Flight
        </button>
